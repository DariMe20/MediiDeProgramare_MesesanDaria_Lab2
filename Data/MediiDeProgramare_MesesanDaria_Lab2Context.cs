...
namespace MediiDeProgramare_MesesanDaria_Lab2.Data
{
    public class MediiDeProgramare_MesesanDaria_Lab2Context : DbContext
    {
        ...
        public DbSet<MediiDeProgramare_MesesanDaria_Lab2.Models.Member>? Member { get; set; }

        public DbSet<MediiDeProgramare_MesesanDaria_Lab2.Models.Borrowing>? Borrowing { get; set; }
    }
}
